...
namespace UnityEngine.InputSystem.Editor
{
    ...
    internal class PlayerInputEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorGUI.EndChangeCheck() || !m_ActionAssetInitialized || assetChanged || m_ActionAssetInstanceID == EntityId.None)
            {
        ...
        bool CheckIfActionAssetChanged()
        {
            if (m_ActionsProperty.objectReferenceValue != null)
            {
                // Unity 6.5: keep EntityId without obsolete int cast.
                var assetInstanceID = m_ActionsProperty.objectReferenceValue.GetEntityId();
                bool result = assetInstanceID != m_ActionAssetInstanceID && m_ActionAssetInstanceID != EntityId.None;
                m_ActionAssetInstanceID = assetInstanceID;
                return result;
            }

            m_ActionAssetInstanceID = EntityId.None;
            return false;
        }
        ...
        [NonSerialized] private EntityId m_ActionAssetInstanceID;
    }
}
#endif // UNITY_EDITOR
